...
const en = {
  ...
  'dashboard.twelveWeekPulse': 'Yearly pulse',
...
const fa: Record<MessageKey, string> = {
  ...
  'events.heading': 'چالش ها و موانع',
  ...
  'dashboard.twelveWeekPulse': 'نبض سالانه',
